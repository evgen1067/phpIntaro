...
/**
 * @param string $str ссылка старого формата
 * @return string ссылка нового формата
 */
function generatingNewUrls(string $str): string
{
...
echo 'Ссылка нового формата: ' . generatingNewUrls($_GET['str']);
